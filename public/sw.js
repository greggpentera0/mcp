// Service Worker for MCP Playground PWA
...
self.addEventListener('push', event => {
  ...
  try {
    ...
    payload = { title: 'MCP Playground', body: event.data.text() };
  }
  ...
  event.waitUntil(
    self.registration.showNotification(payload.title || 'MCP Playground', options)
  );
});
